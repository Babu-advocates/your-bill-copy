...
export const DocumentPreview = forwardRef<HTMLDivElement, DocumentPreviewProps>(
  ({ bill, companyInfo, type }, ref) => {
    const isQuotation = type === 'quotation';
    const documentTitle = isQuotation ? 'QUOTATION' : 'INVOICE';
    const documentLabel = isQuotation ? 'QUOTATION TO :' : 'INVOICE TO :';
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-between mt-6 md:mt-8 relative z-10 gap-4">
          ...
          <div className="text-left sm:text-right">
            ...
            <div>
              <p className="font-semibold text-sm md:text-base">{documentLabel}</p>
        ...
        {/* Footer - positioned at bottom, only show for invoices */}
        {!isQuotation && (
